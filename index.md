...
<div>Analyzing US Influenza Death Rate, and Census data in MS Excel, to identify more vulnerable states and seasonality, and to help allocate medical staff in preparation to the upcoming influenza season. <i>(Dashboard design, Pivot tables, MS Excel)</i>
...
![Video Game sales Analysis](https://github.com/richardpavay/pdf/GameCo sales analysis.pdf)
<div>Analyzing historical videogame sales to identify regional trends, purely in MS Excel</div>
---
